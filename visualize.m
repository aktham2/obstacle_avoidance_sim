function visualize(data, params, moviefile)
%
%   data, params    the output of simulate
%
...
Rz = [c1 -s1 0;
    ...
    Rx = [1 0 0; 
         ...
         0 s3 c3];
    R = Rz*Ry*Rx;
    [~,quadcol] = size(pQuad_InBody);
    [~,bodycol] = size(pBodyFrame_InBody);
for i=1:quadcol
    pQuad_InRoom(:,i) = R*pQuad_InBody(:,i) + o;
end
for i=1:bodycol
    pBodyFrame_InRoom(:,i) = R*pBodyFrame_InBody(:,i) + o;
end
...
function [fig] = UpdateFigure(fig, t, o, o_desired, o_goal, r, obst, ...
    ...
    % update the figure window immediately - shows animation
    drawnow;
